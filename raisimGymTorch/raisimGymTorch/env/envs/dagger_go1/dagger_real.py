...
sys.path.append('/home/none/rl_go1/src')
from src.robots import RealAlienGo
from src import utils
from src.command import Command

sys.path.append('/home/none/rl_go1/submodules/unitree_legged_sdk/lib/python/amd64')
...
for update in range(1201):
    ...
    for step in range(n_steps):        
        if args.real:
            ...
            obs = normalize_observation(obs, actor.mean, actor.var, clip_obs)
