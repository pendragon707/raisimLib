...
from raisimGymTorch.env.bin import dagger_go1_turn_new
...
env = VecEnv(dagger_go1_turn_new.RaisimGymEnv(home_path + "/rsc", yaml.dump(cfg['environment'])), cfg['environment'])
...
saver = ConfigurationSaver(log_dir=home_path + "/raisimGymTorch/data/dagger_go1_turn_new/" + '{:04d}'.format(args.exptid),
...
if wandb:
    ...
    wandb.save(home_path + '/raisimGymTorch/env/envs/dagger_go1_turn_new/Environment.hpp')
...
expert_policy = DaggerExpert(args.loadpth, args.loadid, ob_dim, t_steps,
                             ...
                             n_futures=n_futures, expand = expand)
