...
from raisimGymTorch.env.bin import rsg_go1_turn_new
...
env = VecEnv(rsg_go1_turn_new.RaisimGymEnv(home_path + "/rsc", dump(cfg['environment'], Dumper=RoundTripDumper)), cfg['environment'])
...
saver = ConfigurationSaver(log_dir=home_path + "/raisimGymTorch/data/rsg_go1_turn_new/" + '{:04d}'.format(args.exptid),
...
if wandb:
    ...
    wandb.save(home_path + '/raisimGymTorch/env/envs/rsg_go1_turn_new/Environment.hpp')
