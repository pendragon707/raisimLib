...
# shortcuts
ob_dim = env.num_obs
act_dim = env.num_acts  # change this! 
# act_dim = 12*3  # change this! 
...
saver = ConfigurationSaver(log_dir=home_path + "/raisimGymTorch/data/rsg_go1_back/" + '{:04d}'.format(args.exptid),
...
if wandb:
    ...
    wandb.save(home_path + '/raisimGymTorch/env/envs/rsg_go1_back/Environment.hpp')
